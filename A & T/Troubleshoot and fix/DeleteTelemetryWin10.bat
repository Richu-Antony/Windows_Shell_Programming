...
title Delete Telemetry Win10 V2.11.22
...
echo #
echo  Tool        : Delete Telemetry Win10 V2.11.22                                     
echo  Author      : Richu Antony                                 
echo  Description : Delete Telemetry Windows 10,11                  
echo #
...
:: Ëó÷øå óäàëèòü ÂÑÅ ÏÐÀÂÀ!!! íà ÷òåíèå êàòàëîãà(AutoLogger) ñ ýòèì ôàéëîì, â ýòîì ñëó÷àå ñèñòåìà óæå íèêàê íå ñìîæåò ÷òî-òî çàïèñûâàòü êîãäà-ëèáî
