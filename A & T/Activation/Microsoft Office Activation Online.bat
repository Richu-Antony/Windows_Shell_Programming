...
title  Microsoft Office Activation Tool V31.10.22 9.31

echo.
echo Copyright(C) By Rica Inc.
echo #
echo  Tool        : Microsoft Office Activation Tool V31.10.22 9.31                                     
echo  Author      : Richu Antony                                 
echo  Description : Microsoft Office Activation Tool                
echo #
