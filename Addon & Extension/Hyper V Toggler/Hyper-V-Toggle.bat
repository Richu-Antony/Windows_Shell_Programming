...
title Hyper-V Toggler V6.11.22
...
:INFO
    ...
    ECHO ==========================================================
    ECHO.
    ECHO Hyper-V Toggler %VERSION%
    ECHO.
    echo.
    echo Copyright(C) 2022 By Rica Inc.
    echo #
    echo  Tool        : Hyper-V Toggler V6.11.22                                     
    echo  Author      : Richu Antony                                 
    echo  Description : Hyper-V Toggler                  
    echo #
    echo ==== Thanks for using our service please help us to improve the work by donating and contributing ====
    echo.
    echo.
    ECHO.
    ECHO  A Batch Script Made For Easily Disabling And Enabling Hyper-V For Usage Of Virtualization Products
    ECHO  Without Uninstalling Windows Subsystem For Linux(WSL) And Hyper-V Hypervisor Features In Windows.
